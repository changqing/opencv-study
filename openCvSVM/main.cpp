...
Mat removeLight(Mat img, Mat pattern)
{
  ...
  /*
  cout << "img32.cols = " << img32.cols << endl;
  cout << "img32.rows = " << img32.rows << endl;
  cout << "img32.dims = " << img32.dims << endl;
  cout << "img32.channels = " << img32.channels() << endl;
  cout << "pattern32.cols = " << pattern32.cols << endl;
  cout << "pattern32.rows = " << pattern32.rows << endl;
  cout << "pattern32.dims = " << pattern32.dims << endl;
  cout << "pattern32.channels = " << pattern32.channels() << endl;
  */
  ...
  vector<float> &testData, vector<float> &testResponsesData)
{
  ...
  while( images.read(frame) ){
    //// Preprocess image
    cvtColor(frame, edges, CV_BGR2GRAY);//This will make edges a single channel image
    Mat pre= preprocessImage(edges);
    //cout << "after preprocess image" << endl;
    // Extract features
...
void trainAndTest()
{
  ...
  /* This following code is no longer valid for opencv 3.1
